"""
Reinforcement learning robot path planning for large grid.
...
MAZE_H = 80  # grid height
MAZE_W = 80  # grid width
...
class Maze(tk.Tk, object):
    ...
    def _build_maze(self):
        ...
        # iot 3
        hell31_center = origin + np.array([UNIT * 30, UNIT * 20])
        self.hell31 = self.canvas.create_rectangle(
            hell31_center[0] - 5, hell31_center[1] - 5,
            hell31_center[0] + 5, hell31_center[1] + 5,
            fill='black')
        hell32_center = origin + np.array([UNIT * 30, UNIT * 21])
        ...
        # iot 2
        hell21_center = origin + np.array([UNIT * 10, UNIT * 42])
        self.hell21 = self.canvas.create_rectangle(
            hell21_center[0] - 5, hell21_center[1] - 5,
            hell21_center[0] + 5, hell21_center[1] + 5,
            fill='blue')
        hell22_center = origin + np.array([UNIT * 11, UNIT * 42])
        ...
        # create oval
        oval_center = origin + np.array([UNIT * 79, UNIT * 79])
